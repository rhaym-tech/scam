...
export default (() => {
	return <Theme theme={theme}>
		...
		<Helmet>
			<title>
				58TechBoy is a SCAMMER
			</title>
			<meta name={"description"} content={"Never deal with indians, cause scamming art is flowing in their veins"} />
		</Helmet>
		<Section
		...
		>
			...
			<Box
				...
				background="linear-gradient(180deg,rgba(255, 255, 255, 0.17) 35.2%,rgba(255, 255, 255, 0.08) 100%)"
				border-radius="24px"
